...
answers["Q1"] = f"The short name of the company is {short_name} and it is located in {city}."
...
answers["Q2"] = f"The company has {no_of_platforms} platforms: {', '.join(platforms)}"
...
answers["Q3"] = f"Total number of employees in the company: {no_of_employees}"
print("Total number of employees in the comapny are:", no_of_employees)
print("\n")

#Q4 - Is the company currently active? Print the value from the JSON.
...
for employee in data["employees"]:
    if employee["name"] == "Ravi Kumar":
        answers["Q5"] = f"Ravi Kumar works as a {employee['role']} in the {employee['department']} department."
        print(
            f"Ravi Kumar works as a {employee['role']} in the {employee['department']} department."
        )
print("\n")
